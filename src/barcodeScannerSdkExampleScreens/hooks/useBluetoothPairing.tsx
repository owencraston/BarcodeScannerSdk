...
import BluetoothDeviceModule, {BluetoothPairingListener, PairingState} from '../bluetooth/BluetoothDeviceModule';
import BluetoothDevice from '../bluetooth/utils';
import BluetoothModule from '../bluetooth/BluetoothModule';

export const useBluetoothPairing = (): [PairingState, (bluetoothDevice: BluetoothDevice) => void] => {
